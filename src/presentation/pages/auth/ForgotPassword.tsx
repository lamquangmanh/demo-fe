...
import DirectionalIcon from '@ui/components/DirectionalIcon';
...
export const ForgotPasswordPage = ({ mode }: { mode: Mode }) => {
  // Vars
          ...
          <div className="flex flex-col gap-5">
            ...
            <Form noValidate autoComplete="off" className="flex flex-col gap-5">
              ...
              <Typography
                ...
                color="primary"
              >
                <Link href={LOGIN_PATH} className="flex items-center">
                  <DirectionalIcon
